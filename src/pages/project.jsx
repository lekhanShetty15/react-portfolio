            ...
            <div className="left-project">
                ...
                <div className="project-names">
                    <div className="pname">
                        ...
                        <div
                            className={`projectList ${toggle === 1 ? "active" : ""}`}
                        ...
                        <div
                            className={`projectList ${toggle === 2 ? "active" : ""}`}
                        ...
                        <div
                            className={`projectList ${toggle === 3 ? "active" : ""}`}
                        ...
                        <div
                            className={`projectList ${toggle === 4 ? "active" : ""}`}
                            onClick={() => updateToggle(4)}
                        >
                            <div><i className="fa-solid fa-folder folder"></i></div>
                            <div className="proname">Recipe Finder</div>
                        </div>
            ...
            <div className="right-project">
                <div className={toggle === 1 ? "show-projectHide" : "projectHide"}>
                    <div className="projectTilteName">
                        ...
                        <h1 className="prodate">May 2024</h1>
                    </div>
                ...
                <div className={toggle === 4 ? "show-projectHide" : "projectHide"}>
                    <div className="projectTilteName">
                        <h1 className="projname">Recipe Finder<div className="prolink">link</div></h1>
                        <h1 className="prodate">Jan 2024</h1>
                    </div>
